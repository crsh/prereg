---
title           : "My preregistration based on the Preregistration for Quantitative Research in Psychology Template^[This document was created using the **Preregistration for Quantitative Research in Psychology Template**. The template was developed by a task force composed of members of the American Psychological Association (APA), the British Psychological Society (BPS), the German Psychological Society (DGPs), the Center for Open Science (cos), and the Leibniz Institute for Psychology (ZPID). This work is licensed under the CC BY-NC-SA 4.0 license. To view a copy of the license, visit https://creativecommons.org/licenses/by-nc-sa/4.0/.]"
...
output: prereg::quantitative_research_in_psych_prereg
---
...
## I3
### Hypotheses (H1, H2, ...)
<!-- Provide hypotheses for predicted results. If multiple hypotheses, uniquely number them (e.g., H1, H2a, H2b,) and refer to them the same way at other points in the registration document and in the manuscript. -->
