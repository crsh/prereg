...
6. Optionally, upload any files here that are related to your analyses (e.g., syntaxes, scripts, etc.).
   - You may attach up to 5 files to this question. You may attach files that you already have in this OSF project, or upload a new file from your computer. Uploaded files will automatically be added to this project so that they can be registered. -->
...
Please choose: -->
 ...
 2. Yes, data collection is underway or complete, but we have not yet looked at the data.
 3. Yes, data collection is underway or complete, and we have looked at the data.
